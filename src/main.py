...
from utils import (allocate_to_workers, get_repo_links, main_parallel,
                   segment_links)
...
if __name__ == '__main__':
    ...
    try:
        ...
        for file in PATH_META.parent.iterdir():
            if file.stem.startswith(PATH_META.stem):
    ...
    for links, mpath in zip(links_chunks, meta_files):
        Thread(target=main_parallel, args=(PATH_README, mpath, links, 3,)).start()
